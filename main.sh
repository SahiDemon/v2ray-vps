...
XUI_INSTALL_URL="https://raw.githubusercontent.com/SahiDemon/v2ray-vps/refs/heads/main/install.sh" 
...
install_update_xui() {
    ...
    wget -N --no-check-certificate https://raw.githubusercontent.com/SahiDemon/v2ray-vps/refs/heads/main/x-ui.sh -O /usr/bin/x-ui
